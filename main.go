		...
		if event.Type == linebot.EventTypeMessage {
			...
			case *linebot.TextMessage:
				switch message.Text {
					...
					case "抽": bot.ReplyMessage(event.ReplyToken, linebot.NewImageMessage("http://www.lotpu.com/uploads/allimg/c161209/14Q29B2L340-3W61.jpg","http://www.lotpu.com/uploads/allimg/c161209/14Q29B2L340-3W61.jpg")).Do()
