	...
	for _, event := range events {
		if event.Type == linebot.EventTypeMessage {
			...
			case *linebot.TextMessage:
				...
				if strings.Contains(message.Text,"測試") {bot.ReplyMessage(event.ReplyToken, linebot.NewImagemapMessage("http://www.wyattresearch.com/wp-content/uploads/2015/01/6_logo_predesign.jpg","http://www.wyattresearch.com/wp-content/uploads/2015/01/6_logo_predesign.jpg",linebot.ImagemapBaseSize{100, 100})).Do()}
				if strings.Contains(message.Text,"測試2") {bot.ReplyMessage(event.ReplyToken, linebot.NewTextMessage(type:"image",originalContenUrl:"http://www.wyattresearch.com/wp-content/uploads/2015/01/6_logo_predesign.jpg",previewImageUrl:"http://www.wyattresearch.com/wp-content/uploads/2015/01/6_logo_predesign.jpg")).Do()}
